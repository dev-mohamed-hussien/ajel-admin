  ...
  useEffect(() => {
    if (id) {
      ...
      axios[config.findOne.method](`${config.findOne.url}/${id}`, {
        ...
        .then((response) => {
          setTargetKeys(response.data.data.permissions.map((e) => e.id));
      ...
      <Spin spinning={loading || loadingFormRequireData}>
        ...
        <Row>
          <Col span={24}>
            ...
            >
              <Form.Item
                label={<FormattedMessage id="table.title.Name" />}
                name="name"
                rules={[
                  {
                    required: true,
                    message: <FormattedMessage id="table.title.Name" />,
                  },
                ]}
              >
                ...
                rules={[
                  {
                    ...
                    message: <FormattedMessage id="permissions" />,
                  },
                ]}
              >
                <Transfer
